...
const handleImgInput = async (e) =>{
    let base64 = await  covertTobase64(e.target.files[0]);
    setInput({...input, [e.target.name]: base64});
};
const submitHandler = (e) =>{
  ...
  return (
    <>
        <section className='ml-[69px] mb-[70px]'>
            <div className="w-[1140px] m-auto">
                <div className="">
                    <h1 className='text-[#292930] text-[24px] font-bold mt-6 mb-[40px]'>New Product</h1>
                    <form onSubmit={submitHandler}>
                      <div className="flex flex-wrap items-start justify-between">
                        <div className="w-[48%] flex flex-col gap-11">
                          ...
                          <div className="w-96">                            
                            <label className="block mb-2 text-sm font-medium text-gray-900 ">Samll Details</label>
                            <textarea rows="2" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" 
                              placeholder="Write your Small text here..."
                              type='text'
                              onChange={handleInput}
                              name='smallText'
                            ></textarea>
                          ...
                          <div className="w-96">                            
                            <label className="block mb-2 text-sm font-medium text-gray-900 ">Specifications</label>
                            <textarea rows="2" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" 
                          ...
                          <div className="flex items-center justify-center w-96">
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100">
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p className="text-xs text-gray-500 ">JPEG, PNG, JPG (MAX. 276x276px)</p>
                                </div>
                                <input 
                                  id="dropzone-file" 
                                  type="file" 
                          ...
                          <button type="submit" className=' w-48 hover:scale-105 ease-in-out duration-500 bg-[#3577f0] text-[16px] text-white font-bold px-[30px] focus:outline-none py-4  rounded-md'>Upload Product</button>
                        </div>
                        ...
                        <div className="w-[48%] flex flex-col gap-11">
                            ...
                            <div className="w-96">                            
                              <label className="block mb-2 text-sm font-medium text-gray-900 ">Care & Maintenance</label>
                              <textarea rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" 
                                placeholder="Write your Care & Maintenance here..."
                                type='text'
                                onChange={handleInput}
                                name='careMainText'
                              ></textarea>
                            ...
                            <img src={input.productImg} className='w-96 border-none overflow-hidden' alt="image" />
                        </div>
                      </div>
                    </form>
